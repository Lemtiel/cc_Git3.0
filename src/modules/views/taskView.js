...
export function createInputLabel(
  text,
  inputType,
  inputClass,
  isRequired = false,
...
export function createToDoForm() {
  ...
  const titleLabel = createInputLabel(
    "Title",
    "text",
    "task-title-input",
    true
  ...
  const notesLabel = createInputLabel(
    "Notes",
    "text",
    "task-notes-input",
    false,
...
export function createCheckbox(task) {
  ...
  checkbox.addEventListener("click", (event) => {
    ...
    const textElements = listItem.querySelectorAll(
      ".task-text, .task-text-title"
    );
